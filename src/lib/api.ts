 ...
 * ESP32 & IoT storefront (Template 6) - forked from jams-and-sauces / honey / wire-and-bead.
 */
...
const DEFAULT_COMPANY_SLUG = process.env.NEXT_PUBLIC_COMPANY_SLUG || 'esp32-iot'
