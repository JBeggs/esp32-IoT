...
export const FALLBACK_COMPANY: Company = {
  name: 'ESP32 & IoT Devices',
  tagline: 'Boards, sensors, gateways, and kits for connected projects',
  description: 'Shop ESP32 development boards, MicroPython-ready kits, smart-home modules, sensors, gateways, and IoT accessories.',
  logoUrl: null,
  heroImageUrl: null,
  ogImageUrl: null,
  brandColor: null,
