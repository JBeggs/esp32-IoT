        ...
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              {/* Add to Cart Section */}
              <div className="paper-surface p-6 rounded-2xl space-y-6">
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="text-xs uppercase font-bold tracking-widest paper-muted">Availability</p>
                    {(() => {
                  ...
                  {product.sku && (
                    <div className="text-right space-y-1">
                      <p className="text-xs uppercase font-bold tracking-widest paper-muted">SKU</p>
                      <p className="font-mono text-sm paper-muted">{product.sku}</p>
                    </div>
                  )}
                </div>
                ...
                <div className="grid gap-3 text-sm paper-muted">
                ...
                <p className="text-[10px] text-center paper-muted uppercase tracking-widest font-bold">
                  Practical Support for Connected Builds
                </p>
              </div>
              ...
              <div className="pt-8 border-t border-border-default">
                <div className="paper-surface rounded-2xl p-6 space-y-4">
                  <h3 className="text-sm font-bold uppercase tracking-widest paper-title flex items-center gap-2">
                    <Phone className="w-4 h-4 text-primary" />
                    How to Purchase
                  </h3>
                  <div className="space-y-3">
                    <p className="text-sm paper-muted leading-relaxed">
                      We help you match boards, sensors, firmware paths, and accessories before your build gets stuck.
                    </p>
                    {isHighTouch ? (
                      <div className="paper-surface-muted p-4 rounded-lg border-l-4 border-primary animate-in fade-in slide-in-from-left-2">
                        <p className="text-sm paper-muted leading-relaxed">
                          A representative will contact you to arrange viewing, paperwork, and delivery details before any payment is taken.
                        </p>
                      </div>
                    ) : (
                      <div className="paper-surface-muted p-4 rounded-lg border-l-4 border-secondary animate-in fade-in slide-in-from-left-2">
                        <p className="text-sm paper-muted leading-relaxed">
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t border-[rgb(var(--color-paper-border))]">
                    <div className="text-center group">
                      <div className="paper-icon-tile w-10 h-10 mx-auto mb-2 rounded-full flex items-center justify-center transition-colors">
                        <Phone className="w-5 h-5" />
                      </div>
                      <p className="text-[9px] font-bold uppercase tracking-tighter paper-muted">Guidance</p>
                    </div>
                    <div className="text-center group">
                      <div className="paper-icon-tile w-10 h-10 mx-auto mb-2 rounded-full flex items-center justify-center transition-colors">
                        <Shield className="w-5 h-5" />
                      </div>
                      <p className="text-[9px] font-bold uppercase tracking-tighter paper-muted">Secure</p>
                    </div>
                    <div className="text-center group">
                      <div className="paper-icon-tile w-10 h-10 mx-auto mb-2 rounded-full flex items-center justify-center transition-colors">
                        <FileText className="w-5 h-5" />
                      </div>
                      <p className="text-[9px] font-bold uppercase tracking-tighter paper-muted">Support</p>
                    </div>
                  </div>
                </div>
              </div>
