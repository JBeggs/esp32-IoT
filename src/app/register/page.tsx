      ...
      <div className="max-w-md w-full space-y-8 animate-in fade-in duration-500">
        <div className="paper-surface p-8 rounded-xl">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-bold font-playfair paper-title tracking-tight">Create Account</h1>
            <p className="paper-muted mt-3 text-lg">Join our ESP32 builder community</p>
          </div>
