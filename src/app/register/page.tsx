      ...
      <div className="max-w-md w-full space-y-8 animate-in fade-in duration-500">
        <div className="paper-surface p-8 rounded-xl">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-bold font-playfair paper-title tracking-tight">
              {linkMode ? 'Link Your Account' : 'Create Account'}
            </h1>
            <p className="paper-muted mt-3 text-lg">
              {linkMode ? 'Connect this store to your existing account' : 'Join our ESP32 builder community'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center justify-center pointer-events-none transition-colors group-focus-within:text-vintage-primary z-20">
                  <Phone className="w-5 h-5 paper-muted" />
                </div>
                <input
                  id="phone"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center justify-center pointer-events-none transition-colors group-focus-within:text-vintage-primary z-20">
                  <Mail className="w-5 h-5 paper-muted" />
                </div>
                <input
                  id="email"
              ...
              {emailCheckStatus === 'checking' ? (
                <p className="text-xs paper-muted ml-1">Checking email…</p>
              ) : null}
            </div>
