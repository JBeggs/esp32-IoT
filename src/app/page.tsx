...
import { ArrowRight, Cpu, Package, ShoppingBag } from 'lucide-react'
          ...
          <div className="container-wide">
            <div className="section-header">
              <div>
                ...
                <p className="text-text-muted mt-1">Boards, sensors, gateways, and starter kits</p>
              </div>
      ...
      <section className="py-16 brand-gradient-band">
        <div className="container-wide text-center">
          ...
          <p className="text-lg text-on-dark-muted mb-8 max-w-2xl mx-auto">
            Sign up to hear about new boards, sensor bundles, firmware guides, and project drops.
          </p>
