    ...
    <div className="min-h-screen tech-page-bg">
      <section className="py-12 brand-gradient-band">
        <div className="container-wide">
          <h1 className="text-3xl md:text-4xl font-bold font-playfair mb-2 text-on-dark">Returns & Exchanges</h1>
          <p className="text-lg text-on-dark-muted">{heroSubtitle}</p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container-narrow">
          ...
          <div className="paper-surface mt-8 p-6 rounded-lg">
            <h3 className="font-semibold paper-title mb-2">Need help with a return?</h3>
            <p className="paper-muted mb-4">Our team is here to make the process easy.</p>
